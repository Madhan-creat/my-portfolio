...
export default function ContactMe() {
    ...
    const colors = ['rgb(0, 0, 0)', 'rgb(58, 143, 255)', 'rgb(252, 6, 6)','#53d365'];
    return (
      ...
      {Social.map((item,i)=>{
          return(
              <Grid key={item.id} className="social" style={{backgroundColor:colors[i],}} >
        ...
        Developed By <img src={heart} alt="heart" className="heart"/> by Fiza Waseem
        </Typography>
         </Grid>
