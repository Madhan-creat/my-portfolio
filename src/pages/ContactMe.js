  ...
  const Social = [
    {
      ...
      link: "https://github.com/Madhan-creat",
    },
    {
      id: 2,
      name: <LinkedInIcon className="icon" />,
      link: "https://www.linkedin.com/in/madhan-mohan-reddy-eaddula-8020b218a/",
    },
    {
      id: 3,
      name: <MailIcon className="icon" />,
      link: "https://madhantruly@gmail.com",
    },
    {
      id: 4,
      name: <WhatsAppIcon className="icon" />,
      link: "https://wa.me/9381688685 ",
    },
    ...
    <div id="contact" className="conainer-fluid mt-5">
      <Grid xs={12} className="contact">
        <Typography className="contactMe">
          Get in touch <img src={call} alt="phone" className="victory" />
        </Typography>
        ...
        <Typography className="projectText">
          Developed By <img src={heart} alt="heart" className="heart" /> by Madhan
          Dalmia
        </Typography>
      </Grid>
    </div>
